...
ImgView::ImgView(int x, int y, int w, int h, const char *label) : Fl_Double_Window(x,y,w,h,label)
{
	...
	//Fixed by Avanish - Select the Image_with_contour option 
	scissorPanelUI->contour->value(1);
	//Fixed by Avanish - Select the Whole Image option 
...
void ImgView::OpenImage(const char *filename)
{
	...
	//  Fixed by Avanish - *DO NOT* Select the Image_with_contour option. Let it remain in whatever state it is. 
	//	scissorPanelUI->contour->value(1);
	...
	brushSelPtr = NULL;
	//  Fixed by Avanish - *DO NOT* Select the whole image option. Let it remain in whatever state it is.
	//	scissorPanelUI->whole->value(1);
