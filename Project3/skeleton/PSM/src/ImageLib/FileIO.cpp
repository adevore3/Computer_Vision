...
{
    T temp = value;
    char* ptrByte_value = reinterpret_cast<char *>(&value); // let ptrByte_value point to value
    char* ptrByte_temp = reinterpret_cast<char *>(&temp); // let ptrByte_temp point to temp
